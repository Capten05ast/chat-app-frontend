          ...
          <div style={{display:"flex", alignItems:"center", gap:10, padding:"11px 16px", position:"relative", zIndex:1}}>
            ...
            <div style={{flex:1, display:"flex", alignItems:"center", justifyContent:"center"}}>
              ...
              <div className="nav-mobile-only" style={{display:"flex", alignItems:"center", gap:8}}>
                ...
                <span style={{color:"white", fontWeight:900, fontSize:19, letterSpacing:"-0.6px"}}>
              ...
              <div className="nav-desktop" style={{display:"none", alignItems:"center", gap:10, width:"100%", maxWidth:500}}>
                ...
                <button
                  ...
                  style={{
                    ...
                    padding:"9px 18px", background:"white", color:"#7c3aed",
                  ...
                  onMouseEnter={e => { e.currentTarget.style.transform="translateY(-1px)"; e.currentTarget.style.boxShadow="0 6px 20px rgba(0,0,0,0.28)"; }}
                  onMouseLeave={e => { e.currentTarget.style.transform="none"; e.currentTarget.style.boxShadow="0 2px 14px rgba(0,0,0,0.22)"; }}
                >
            ...
            <div style={{display:"flex", alignItems:"center", gap:8, flexShrink:0}}>
                ...
                {showConnectInput && (
                  <div className="connect-overlay" style={{
                    ...
                    <button
                      onClick={handleConnect}
                      style={{
                        padding:"11px 20px", background:"white", color:"#7c3aed",
                    ...
                    <button
                      ...
                      style={{background:"none", border:"none", color:"rgba(255,255,255,0.85)", cursor:"pointer", padding:8, flexShrink:0}}
                    >
              ...
              <div style={{position:"relative"}}>
                <button
                  ...
                  style={{
                    background: showInvites ? "rgba(255,255,255,0.32)" : undefined,
                    borderColor: showInvites ? "rgba(255,255,255,0.55)" : undefined,
                  }}
                >
                ...
                {showInvites && (
                  <div className="drop-anim" style={{
                    ...
                    width:348, maxWidth:"calc(100vw - 24px)",
                    background:"white",
                    borderRadius:22,
                    ...
                    <div style={{
                      ...
                      <div>
                        ...
                        <p style={{margin:"3px 0 0", fontSize:12, color:"#7c3aed", fontWeight:700}}>
                          {pendingInvites.length > 0 ? `${pendingInvites.length} waiting for you` : "You're all caught up!"}
                        </p>
                      </div>
                      {pendingInvites.length > 0 && (
                        <div style={{
                        ...
                        {pendingInvites.map((group, idx) => (
                          ...
                          >
                            ...
                            <div style={{flex:1, minWidth:0}}>
                              <p style={{margin:0, fontSize:15, fontWeight:900, color:"#0f0f0f", overflow:"hidden", textOverflow:"ellipsis", whiteSpace:"nowrap"}}>
                                {group.name}
                              </p>
                              <p style={{margin:"3px 0 0", fontSize:12, color:"#6b7280", fontWeight:600}}>
                                Invited by {group.admin.fullName.firstName}
                              </p>
                            </div>
              ...
              <button
                ...
                title="Logout"
                onMouseEnter={e => { e.currentTarget.style.background="rgba(239,68,68,0.38)"; e.currentTarget.style.borderColor="rgba(239,68,68,0.5)"; }}
